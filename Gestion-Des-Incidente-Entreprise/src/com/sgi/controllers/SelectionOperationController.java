...
public class SelectionOperationController {
	...
	public SelectionOperationController(UISelectionOperation uiSelectionOperation,
			UIAuthentification _uIAuthentification) {
			...
			public void actionPerformed(ActionEvent e) {
				...
				switch (operation)
				{
					case CREER_INCIDENT:
						...
						CreerIncidentController creerIncidentController = new CreerIncidentController (uiCreerIncident,uIAuthentification);
					...
					case VISUALISER_INCIDENT:
						...
						VisualiserIncidentController visualiserIncidentController = new 
								VisualiserIncidentController (uiVisualiserIncident,uIAuthentification);
